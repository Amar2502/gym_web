...
export function IconBarbell({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M6 9v6M18 9v6M3 10v4M21 10v4M7 12h10" strokeLinecap="round" />
    </svg>
  );
}

export function IconMuscle({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M8 14c0-2 1.5-4 4-4s4 2 4 4M6 18h12M9 8V6a3 3 0 0 1 6 0v2" strokeLinecap="round" strokeLinejoin="round" />
...
export function IconUser({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      <path d="M4 20v-1a6 6 0 0 1 6-6h4a6 6 0 0 1 6 6v1" strokeLinecap="round" />
    </svg>
  );
}

export function IconNutrition({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M12 3v18M8 7c0-2 1.5-4 4-4s4 2 4 4v14H8V7z" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function ProgramIcon({
  ...
  name: keyof typeof programIconMap;
  className?: string;
}) {
  const Icon = programIconMap[name];
